function dynstructure(cid,cid_old,sp_v,e_b,n_b0,tp_m,tind_m,mp_m,mind_m,int_id,athresh,nthresh)
    ...
    #Resource overlap
    res_overlap, user_overlap = roverlap(cid,sp_v,e_b,n_b0);
    ...
    pc, lpc = potcol(sp_v,int_id,cid,e_b,n_b0,athresh,nthresh);
